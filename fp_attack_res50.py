    ...
    for layer_name in res50_layer_list:
        ...
        for i, (x, y) in (enumerate(val_loader)):
            if i != args.num // args.batchsize:
                ...
                with torch.no_grad():
                    target_y = getTarClas(x, y, resnet_50, args.byRank)
                    furthest_feature = getFurthestFeature(x, resnet_50, target_y, library, args.method, args.kernel_for_furthe, args.GAA, args.c)
                x_adv = attack_fp(x, furthest_feature, resnet_50, args.kernel_type, args.GAA, args.c, args.method).detach_()
                # save adv img
